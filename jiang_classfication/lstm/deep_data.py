...
def load_data():
    # 不设置fix_length
    TEXT = data.Field(sequential=True, fix_length=500)  # 词或者字符
    ...
    train_path = 'util/article/train_set.csv'
    test_path = 'util/article/test_set.csv'
    val_path = 'util/article/val_set.csv'
