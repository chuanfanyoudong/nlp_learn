...
@software: PyCharm
@file: batch_lstm_crf.py
@time: 2019/1/17 13:40
"""
...
class lstm_crf(nn.Module):
    def __init__(self, vocab_size, num_tags,  EMBED_SIZE, HIDDEN_SIZE, vectors):
        super().__init__()
        self.lstm = lstm(vocab_size, num_tags, EMBED_SIZE, HIDDEN_SIZE)
...
class lstm(nn.Module):
    def __init__(self, vocab_size, num_tags, EMBED_SIZE, HIDDEN_SIZE):
        super().__init__()
